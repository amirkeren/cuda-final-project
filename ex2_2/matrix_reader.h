...
public:
  ...
  public:
    matrix_meta (unsigned int rows_count_arg, unsigned int cols_count_arg, unsigned int non_zero_count_arg, format matrix_format_arg, data_type matrix_data_type_arg, storage_scheme matrix_storage_scheme_arg): 
		rows_count(rows_count_arg), cols_count(cols_count_arg), non_zero_count(non_zero_count_arg), matrix_format(matrix_format_arg), matrix_data_type(matrix_data_type_arg), matrix_storage_scheme(matrix_storage_scheme_arg) {}
  ...
  std::size_t get_rows_count() const { return meta.rows_count; }
  std::size_t get_cols_count() const { return meta.cols_count; }

  virtual const unsigned int* get_row_ids() const = 0;
  virtual const unsigned int* get_col_ids() const = 0;
